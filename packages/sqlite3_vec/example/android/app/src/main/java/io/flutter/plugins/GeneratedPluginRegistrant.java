...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new me.movenext.sqlite3_vec.Sqlite3VecPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin sqlite3_vec, me.movenext.sqlite3_vec.Sqlite3VecPlugin", e);
    }
  }
}
