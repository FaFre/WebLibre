...
class GeckoEngineSettingsApi {
  ...
  Future<void> setBrowserHandlingScrollEnabled(bool enabled) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mozilla_components.GeckoEngineSettingsApi.setBrowserHandlingScrollEnabled$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
