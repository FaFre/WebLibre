...
class GeckoContainerProxyApi {
  ...
  Future<void> setStrictContexts(Map<String, List<String>> contexts) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mozilla_components.GeckoContainerProxyApi.setStrictContexts$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
class GeckoPushApi {
  ...
  Future<void> suspendForProfileSwitch(String targetProfileId) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mozilla_components.GeckoPushApi.suspendForProfileSwitch$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
